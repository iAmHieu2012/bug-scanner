...
data class BugInfo(
    ...
    /**
     * Trả về danh sách hình ảnh đã được lọc và loại bỏ các ảnh trùng lặp hoặc placeholder.
     *
     * @param excludedUrls Tập hợp các URL cần loại trừ khỏi danh sách (mặc định là tập rỗng).
     * @return Danh sách URL hình ảnh hợp lệ.
     */
...
/**
 * Kiểm tra xem một URL có phải là ảnh placeholder mặc định hay không.
 *
 * @return True nếu URL chứa từ khóa placeholder đã biết, ngược lại là False.
 */
