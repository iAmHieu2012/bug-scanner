    ...
    Card(
        ...
        Column {
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Text(text = bug.name, style = MaterialTheme.typography.titleLarge, color = MaterialTheme.colorScheme.primary)
                Text(text = bug.scientificName, style = MaterialTheme.typography.labelMedium, color = MaterialTheme.colorScheme.secondary)
